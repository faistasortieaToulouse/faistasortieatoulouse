...
        </Card>
        ...
        {/* ----------------------------------------------------------------------------------------------------------------------------------- */}
        {/* NOUVELLE CARTE DE L'HÉBERGEUR (Correction Vercel) */}
        <Card>
          <CardHeader>
            <CardTitle>Hébergeur et Infrastructure du site</CardTitle>
          </CardHeader>
          <CardContent>
                <p className="font-semibold mb-1">Hébergement Principal et Déploiement</p>
            <p>L'hébergement et le déploiement du site (Frontend et API Routes) sont assurés par :</p>
                ...
                <p className="font-semibold mt-4 mb-1">Services d'Infrastructure Complémentaires</p>
                <p>L'application utilise également les services suivants :</p>
                <div className="ml-4 mt-2">
                    <p><strong>Code Source (GitHub)</strong></p>
                    <p>GitHub, Inc.</p>
                    <p>88 Colin P Kelly Jr St, San Francisco, CA 94107, États-Unis.</p>
                </div>
                <div className="ml-4 mt-2">
                    <p><strong>Services Cloud & API (Google/Firebase)</strong></p>
...
        </Card>
        ...
        {/* NOUVELLE CARTE : Note sur la Communauté Discord */}
        <Card>
          <CardHeader>
...
            <p className="font-bold text-red-600 dark:text-red-400">
            ...
            <p className="mt-2">
                Le site sert de portail d'accès et de tableau de bord pour la communauté. 
                L'organisation des sorties, les discussions en temps réel et la modération de la communauté sont gérées 
                exclusivement sur notre serveur 
                <a href="[Lien de votre Discord]" target="_blank" className="text-primary hover:underline font-semibold">Discord</a>. 
