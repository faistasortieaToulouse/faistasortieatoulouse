...
// --- Liste complète des images du carrousel (URLs déjà complètes) ---
const IMAGE_URLS = [
  ...
  'https://faistasortieatoulouse.vercel.app/images/theatre600.jpg',
  'https://faistasortieatoulouse.vercel.app/images/yoga600.jpg',
  'https://faistasortieatoulouse.vercel.app/images/zumba600.jpg',
];

// --- Conversion en objets CarouselImage ---
const images: CarouselImage[] = IMAGE_URLS.map((url, index) => ({
  id: `img-${index}`,
  imageUrl: url,
